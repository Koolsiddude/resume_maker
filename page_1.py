      ...
      <div class="section-extra_activities">
        <table>
            ...
            <tr class="live-project">
              <th id="comp_name" colspan="4">Certifications</th>
              <td id="des" colspan="4">
            ...
            <tr class="live-project">
              <th id="comp_name" colspan="4">Live Projects</th>
              <td id="des" colspan="4">
                <table class="live-project">
            ...
            <tr class="live-project">
              <th id="comp_name" colspan="4">Position of Responsibility</th>
              <td id="des" colspan="4">
                <table class="live-project">
            ...
            <tr class="live-project">
              <th id="comp_name" colspan="4">Social Projects</th>
              <td id="des" colspan="4">
                <table class="live-project">
            ...
            <tr class="live-project">
              <th id="comp_name" colspan="4">Skills</th>
              <td id="des" colspan="4">
                <table class="live-project">
                  {% for sk in skills %}
                  <tr>
      ...
      <div class="section-academic-achievements">
        <table>
          <thead>
            ...
            <tr class="live-project">
              <th id="comp_name" colspan="4">Research Papers</th>
              <td id="des" colspan="4">
                <table class="live-project">
