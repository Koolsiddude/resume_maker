...
if include_projects:
    ...
    for i in range(num_projects):
        with st.expander(f"Project {i + 1}"):
            ...
            project_description = st.text_area(f"Project Description (Separate by commas)",key=f"Project Description {i + 1}")
            projects.append({
                "name": project_name,
                "date": project_date,
...
<html lang="en">
  ...
  <body>
    <div class="container">
      <div class="header">
        <img src="https://github.com/Koolsiddude/resume_maker/blob/34354dbde3fe4cd8165e65bd221b2993b40cc917/vbs-logo-removebg-preview.png" alt="Institution Logo" style="float: right;bottom: 20vh; margin-left: 10px; width: 25vh; height: auto;"></img>
        <h1>{{name}}</h1>
        <p>
          Email:
