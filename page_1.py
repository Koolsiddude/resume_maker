...
<html lang="en">
  ...
  <body>
       ...
       template += """
        ...
        <table>
          ...
          <div class="section-extra_activities">
            <table>
                <tr class="title-work-new">
                  <th class="ttitle-work-new" colspan="5">
                    Co-Curricular & Extra-Curricular Activities
                  </th>
                </tr>
      """ 
   ...
   if "include_skills" in params:
      ...
      """
   if "include_res" in params and not "include_sc" in params:
       template += """
        <div class="section-academic-achievements">
        <table>
          <thead>
            <tr class="title-work-new">
              <th class="title-work-new" colspan="5">Academic Achievements</th>
            </tr>
            <tr class="live-project">
...
"""
   if "include_sc" in params and not "include_res" in params:
       template +="""
        <div class="section-academic-achievements">
        <table>
          <thead>
      ...
      <div class="section-hobbies">
        ...
        """
   if "include_sc" in params and "include_res" in params:
       template +="""
             <div class="section-academic-achievements">
        <table>
          <thead>
...
"""
   if not "include_res" in params and not "include_sc" in params:
       template +="""
        <div class="section-academic-achievements">
            <table>
              <thead>
...
if include_work_experience:
    ...
    for i in range(num_jobs):
        with st.expander(f"Experience {i + 1}"):
            ...
            details = st.text_area(f"Responsibilities (Separate by commas)",key =f"responsibility_work{i + 1}")
...
if include_sc:
    ...
    sc = []
    selected_params.append("scholarships")
