...
if include_ar:
    ...
    num_ar = st.number_input("Number of Achievements & Rewards", min_value=1, max_value=10, value=1)
    for i in range(num_ar):
        with st.expander(f"Achievements & Rewards {i + 1}"):
            ar_description = st.text_area(f"Title",key=f"ar_title {i + 1}")
            ar.append({
