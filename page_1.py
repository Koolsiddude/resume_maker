...
<html lang="en">
  ...
  <body>
    <div class="container">
      <div class="header">
        <img src="https://github.com/Koolsiddude/resume_maker/blob/main/vbs-logo-removebg-preview.png" alt="Institution Logo" style="float: right;bottom: 20vh; margin-left: 10px; width: 25vh; height: auto;"></img>
        <h1>{{name}}</h1>
        <p>
          Email:
